...
async function fetchUser(id: string): Promise<ProductType> {
        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-4/6 mx-auto flex flex-wrap">
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <h1 class="text-gray-800 text-3xl font-bold mb-1">
              ...
              <div class="flex flex-col pt-8 gap-4">
                ...
                <button class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded lg:w-28">
                  Order
                </button>
              </div>
            </div>
